...
/// [`idct4x4`] specialised for blocks whose only nonzero coefficient is the
/// DC: every output collapses to `(dc + 4) >> 3`. The common case for coded
/// blocks at web quality levels, and ~free next to the 32-multiply full
/// transform.
