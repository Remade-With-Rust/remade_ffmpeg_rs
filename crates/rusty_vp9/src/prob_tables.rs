//! VP9 default probability tables - GENERATED from libvpx (BSD-3),
//! validated on extraction (counts, ranges). Do not edit by hand.

#![allow(clippy::all)]
#![allow(dead_code)] // consumed by the token decoder (stage D)

/// `default_coef_probs` model form: [tx][plane][ref][band][ctx][node].
/// Band 0 has 3 real contexts; ctx 3..6 are zero padding (never read).
pub(crate) const DEFAULT_COEF_PROBS: [[[[[[u8; 3]; 6]; 6]; 2]; 2]; 4] = [
    [
        [
            [
                [
...
/// `vp9_pareto8_full[p-1]` expands a model pivot prob to 8 tail nodes.
pub(crate) const PARETO8_FULL: [[u8; 8]; 255] = [
...
pub(crate) const KF_Y_MODE_PROBS: [[[u8; 9]; 10]; 10] = [
    [
...
pub(crate) const KF_UV_MODE_PROBS: [[u8; 9]; 10] = [
...
pub(crate) const KF_PARTITION_PROBS: [[u8; 3]; 16] = [
    [158, 97, 94],
    [93, 24, 99],
    [85, 119, 44],
    [62, 59, 67],
...
pub(crate) const INV_MAP_TABLE: [u8; 255] = [
...
pub(crate) const CAT1_PROB: [u8; 1] = [159];
pub(crate) const CAT2_PROB: [u8; 2] = [165, 145];
pub(crate) const CAT3_PROB: [u8; 3] = [173, 148, 140];
pub(crate) const CAT4_PROB: [u8; 4] = [176, 155, 140, 135];
pub(crate) const CAT5_PROB: [u8; 5] = [180, 157, 141, 134, 130];
pub(crate) const CAT6_PROB: [u8; 14] = [
    254, 254, 254, 252, 249, 243, 230, 196, 177, 153, 140, 133, 130, 129,
];
/// Category-6 extra-bit probabilities for 10-bit (`cat6_prob_high10`, libvpx):
/// two extra high bits prepended (16 bits read total at 10-bit).
pub(crate) const CAT6_PROB_HIGH10: [u8; 16] = [
    255, 255, 254, 254, 254, 252, 249, 243, 230, 196, 177, 153, 140, 133, 130, 129,
];
/// Category-6 extra-bit probabilities for 12-bit (`cat6_prob_high12`): four
/// extra high bits prepended (18 bits read total at 12-bit).
pub(crate) const CAT6_PROB_HIGH12: [u8; 18] = [
    255, 255, 255, 255, 254, 254, 254, 252, 249, 243, 230, 196, 177, 153, 140, 133, 130, 129,
];

// ---- inter-frame default probabilities (libvpx vp9_entropymode.c) --------

/// `default_if_y_probs[BLOCK_SIZE_GROUPS][INTRA_MODES-1]`.
pub(crate) const DEFAULT_IF_Y_PROBS: [[u8; 9]; 4] = [
...
pub(crate) const DEFAULT_IF_UV_PROBS: [[u8; 9]; 10] = [
...
pub(crate) const DEFAULT_PARTITION_PROBS: [[u8; 3]; 16] = [
    [199, 122, 141],
    [147, 63, 159],
    [148, 133, 118],
    [121, 104, 114],
...
pub(crate) const DEFAULT_INTER_MODE_PROBS: [[u8; 3]; 7] = [
    [2, 173, 34],
    [7, 145, 85],
    [7, 166, 63],
    [7, 94, 66],
...
pub(crate) const DEFAULT_INTRA_INTER_P: [u8; 4] = [9, 102, 187, 225];
pub(crate) const DEFAULT_COMP_INTER_P: [u8; 5] = [239, 183, 119, 96, 41];
pub(crate) const DEFAULT_COMP_REF_P: [u8; 5] = [50, 126, 123, 221, 226];
pub(crate) const DEFAULT_SINGLE_REF_P: [[u8; 2]; 5] =
    [[33, 16], [77, 74], [142, 142], [172, 170], [238, 247]];
pub(crate) const DEFAULT_SWITCHABLE_INTERP_PROB: [[u8; 2]; 4] =
...
/// libvpx `default_nmv_context`.
pub(crate) const DEFAULT_NMV_CONTEXT: NmvContext = NmvContext {
    joints: [32, 64, 96],
    comps: [
        NmvComp {
            sign: 128,
