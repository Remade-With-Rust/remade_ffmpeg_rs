...
fn print_help() {
    ...
    println!("  -preset P          encoder speed/quality (h264: fast|medium|slow)");
    println!("  -profile P         encoder profile (h264: baseline|main|high)");
    println!("  -g N               keyframe interval in frames");
